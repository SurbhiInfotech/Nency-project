...
var sid;
class UpStudAddQualification extends StatefulWidget {
  const UpStudAddQualification({ Key? key }) : super(key: key);

  @override
  State<UpStudAddQualification> createState() => _UpStudAddQualificationState();
}

class _UpStudAddQualificationState extends State<UpStudAddQualification> {
  TextEditingController  addqualification= TextEditingController();
  ...
  String purl = url+"?what=studaddqualication&sid=${sid}&addqualification=${addqualification}&cmatscore=${cmatscore}";
      //";
