...
var sid;
class UpStudentWorkExp extends StatefulWidget {
  const UpStudentWorkExp({ Key? key }) : super(key: key);

  @override
  State<UpStudentWorkExp> createState() => _UpStudentWorkExpState();
}

class _UpStudentWorkExpState extends State<UpStudentWorkExp> {
  TextEditingController  totalworkexp= TextEditingController();
  TextEditingController  lastsalary= TextEditingController();
  TextEditingController  firstorgname= TextEditingController();
  TextEditingController  firstdesignation= TextEditingController();
TextEditingController firstduration = TextEditingController();
TextEditingController secorgname = TextEditingController();
TextEditingController secdesignation = TextEditingController();
TextEditingController secduration = TextEditingController();
...
int view=0;
  ...
  String purl = url+"?what=studworkexp&sid=${sid}&totalworkexp=${totalworkexp}&lastsalary=${lastsalary}&firstorgname=${firstorgname}&firstdesignation=${firstdesignation}&firstduration=${firstduration}&secorgname=${secorgname}&secdesignation=${secdesignation}&secduration=${secduration}";
      //";
