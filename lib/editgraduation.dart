...
var sid;
class EditStudentGradD extends StatefulWidget {
  const EditStudentGradD({ Key? key }) : super(key: key);

  @override
  _EditStudentGradDState createState() => _EditStudentGradDState();
}

class _EditStudentGradDState extends State<EditStudentGradD> {
  TextEditingController  gdegree= TextEditingController(text:graduationobj!.student[0].gdegree);
  TextEditingController  specialization= TextEditingController(text:graduationobj!.student[0].specialization);
  TextEditingController  yearcomplete= TextEditingController(text:graduationobj!.student[0].yearcomplete);
  TextEditingController  cgpi= TextEditingController(text:graduationobj!.student[0].cgpi);
TextEditingController percentage = TextEditingController(text:graduationobj!.student[0].percentage);
TextEditingController gclass = TextEditingController(text:graduationobj!.student[0].gclass);
TextEditingController gcollegename = TextEditingController(text:graduationobj!.student[0].gcollegename);
TextEditingController gcollegeadd = TextEditingController(text:graduationobj!.student[0].gcollegeadd);
TextEditingController gcollegecity = TextEditingController(text:graduationobj!.student[0].gcollegecity);
TextEditingController gcollegepincode = TextEditingController(text:graduationobj!.student[0].gcollegepincode);
TextEditingController guniversity = TextEditingController(text:graduationobj!.student[0].guniversity);
TextEditingController ganygapp = TextEditingController(text:graduationobj!.student[0].ganygapp);
TextEditingController ggapyear = TextEditingController(text:graduationobj!.student[0].ggapyear);
int view=0;
                          ...
                          OutlinedButton(
                                           onPressed: (){
                                            sid=userobj!.student[0].sid;
                                             ...
                                             Navigator.push(context, MaterialPageRoute(builder: (context)=>StudViewGraduation()));
                                           }, 
                                           child: 
