...
class EditStudSumInternD extends StatefulWidget {
  const EditStudSumInternD({ Key? key }) : super(key: key);

  @override
  _EditStudSumInternDState createState() => _EditStudSumInternDState();
}

class _EditStudSumInternDState extends State<EditStudSumInternD> {
  TextEditingController  siptitle= TextEditingController(text:internobj!.student[0].siptitle);
  TextEditingController  sipcompany= TextEditingController(text:internobj!.student[0].sipcompany);
  TextEditingController  sipcity= TextEditingController(text:internobj!.student[0].sipcity);
  TextEditingController  sippincode= TextEditingController(text:internobj!.student[0].sippincode);
int view=0;
                        ...
                        children: [
                          ...
                          OutlinedButton(
                                           onPressed: (){
                                             ...
                                             Navigator.push(context, MaterialPageRoute(builder: (context)=>StudViewInternship()));
                                           }, 
                                           child: 
  ...
  String purl = url+"?what=editinternship&sid=${sid}&siptitle=${siptitle}&sipcompany=${sipcompany}&sipcity=${sipcity}&sippincode=${sippincode}";
      //";
