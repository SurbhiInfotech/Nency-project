...
class Studviewapplycom extends StatefulWidget {
  const Studviewapplycom({ Key? key }) : super(key: key);

  @override
  State<Studviewapplycom> createState() => _StudviewapplycomState();
}

class _StudviewapplycomState extends State<Studviewapplycom> {
                          ...
                          child: Column(
                            ...
                            children:<Widget> [
                             ...
                             trailing: Column(children: [
                               OutlinedButton(
                            onPressed: (){
                             // var cid=companydata[index]['cid'].toString();
                            var applyid=companydata[index]['applyid'].toString();
                              deleteapply(applyid);
  ...
  getstudentapplydisplay(String sid) async
{
  ...
  //inspect("applyid:"+applyid);
    String urls=url+"?what=getstudentapplydetails&sid=${sid}";
...
Future deleteapply(String applyid) async {
 ...
 // inspect("selectedoption:"+selectedoption);
  String purl = "?what=deleteapply&applyid=${applyid}";
      //";
