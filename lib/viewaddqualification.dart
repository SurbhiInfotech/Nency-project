...
class StudViewaddqualification extends StatefulWidget {
  const StudViewaddqualification({ Key? key }) : super(key: key);

  @override
  State<StudViewaddqualification> createState() => _StudViewaddqualificationState();
}

class _StudViewaddqualificationState extends State<StudViewaddqualification> {
  int view=0;
  @override
